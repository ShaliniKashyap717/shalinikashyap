	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'skill-pattern': 'linear-gradient(135deg, rgba(255, 255, 255, 0.05) 25%, transparent 25%, transparent 50%, rgba(255, 255, 255, 0.05) 50%, rgba(255, 255, 255, 0.05) 75%, transparent 75%, transparent)',
			},
			boxShadow: {
				'glass': '0 4px 30px rgba(0, 0, 0, 0.3)',
				'glass-strong': '0 8px 32px rgba(0, 0, 0, 0.5)',
				'neon': '0 0 5px theme("colors.primary.DEFAULT"), 0 0 20px rgba(0, 0, 0, 0.3)',
